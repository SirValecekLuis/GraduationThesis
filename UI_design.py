...
class UIMainWindow(QtWidgets.QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.LABEL_GRAPHS_INFO = QtWidgets.QLabel(self.tab_2)
        self.LABEL_GRAPHS_INFO.setGeometry(QtCore.QRect(30, 30, 391, 161))
        self.LABEL_GRAPHS_INFO.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
        self.LABEL_GRAPHS_INFO.setObjectName("LABEL_GRAPHS_INFO")
    ...
    def style_sheet(self):
        ...
        self.CPU_MAIN_LABEL.setText(_translate("main_window",
                                               "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">CPU - procesor</span></p></body></html>"))
        self.GPU_MAIN_LABEL.setText(_translate("main_window",
                                               "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">GPU - grafický čip</span></p></body></html>"))
        self.cpu_frequency_label.setText(_translate("main_window",
                                                    "<html><head/><body><p><span style=\" font-size:12pt;\">Frekvence procesoru MHz: </span></p></body></html>"))
        self.cpu_cores_label.setText(_translate("main_window",
                                                "<html><head/><body><p><span style=\" font-size:12pt;\">Počet jader: </span></p></body></html>"))
        self.cpu_name_label.setText(_translate("main_window",
                                               "<html><head/><body><p><span style=\" font-size:12pt;\">Název procesoru: AMD Athlon II X4 640 Processor</span></p></body></html>"))
        self.cpu_min_temperature_label.setText(_translate("main_window",
                                                          "<html><head/><body><p><span style=\" font-size:12pt;\">Nejmenší naměřená teplota °C: </span></p></body></html>"))
        self.cpu_max_temperature_label.setText(_translate("main_window",
                                                          "<html><head/><body><p><span style=\" font-size:12pt;\">Největší naměřená teplota °C: </span></p></body></html>"))
        self.cpu_load_label.setText(_translate("main_window",
                                               "<html><head/><body><p><span style=\" font-size:12pt;\">Aktuální zátěž procesoru %: </span></p></body></html>"))
        self.gpu_name_label.setText(_translate("main_window",
                                               "<html><head/><body><p><span style=\" font-size:12pt;\">Název grafické karty: </span></p><p><span style=\" font-size:12pt;\"><br/></span></p></body></html>"))
        self.gpu_total_memory_label.setText(_translate("main_window",
                                                       "<html><head/><body><p><span style=\" font-size:12pt;\">Celkové množství VRAM MB: </span></p></body></html>"))
        self.gpu_memory_used_label.setText(_translate("main_window",
                                                      "<html><head/><body><p><span style=\" font-size:12pt;\">Aktuální vytížení paměti VRAM %: </span></p></body></html>"))
        self.gpu_fan_load_label.setText(_translate("main_window",
                                                   "<html><head/><body><p><span style=\" font-size:12pt;\">Zatížení větráčků na grafické kartě %: </span></p></body></html>"))
        self.gpu_temperature_label.setText(_translate("main_window",
                                                      "<html><head/><body><p><span style=\" font-size:12pt;\">Aktuální teplota C°: </span></p></body></html>"))
        ...
        self.LABEL_GRAPHS_INFO.setText(_translate("main_window",
                                                  "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Grafy znázorňující informace v závislosti na čase.</span></p><p><span style=\" font-size:11pt; font-weight:600;\">Pro výběr stačí pomocí zakřížkování vybrat dané </span></p><p><span style=\" font-size:11pt; font-weight:600;\">informace, které se mají na ose Y zobrazit. <br/><br/>Osa X je popsaná časově, každá aktualizace </span></p><p><span style=\" font-size:11pt; font-weight:600;\">probíhá po 1s.</span></p></body></html>"))
        self.label_time.setText(_translate("main_window",
                                           "<html><head/><body><p><span style=\" font-size:12pt;\">Délka měření: </span></p></body></html>"))
        self.label_data_amount.setText(_translate("main_window",
                                                  "<html><head/><body><p><span style=\" font-size:12pt;\">Počet sekvencí: </span></p></body></html>"))
        self.LABEL_GPU.setText(_translate("main_window",
                                          "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Nastavení osy Y pro GPU:</span></p></body></html>"))
        self.LABEL_CPU.setText(_translate("main_window",
                                          "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Nastavení osy Y pro CPU:</span></p></body></html>"))
